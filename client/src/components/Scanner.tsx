...
export default function Scanner({
  ...
  return (
    <section className="panel scanner">
      <h2 className="panel-title">MID-CAP SCANNER — ranked by tradeability criteria, not advice.</h2>
      <p className="scanner-meta">
        {state
          ? `${state.eligible}/${state.universeSize} universe symbols in the $2B–$10B band · updated ${state.updatedAt ? fmtAge(state.updatedAt) : '—'} · rescans every 60s`
